# Backstage Release 1.53.2

## Compared to 1.53.1 (previous patch release)

0 added, 0 removed, 3 upgraded, 208 unchanged.

### Version bumps

| Package | 1.53.1 | 1.53.2 | Type |
| --- | --- | --- | --- |
| `@backstage/plugin-catalog-backend` | 3.8.1 | 3.8.2 | Patch |
| `@backstage/plugin-scaffolder-backend` | 4.0.2 | 4.0.3 | Patch |
| `@backstage/plugin-scaffolder-common` | 2.2.1 | 2.2.2 | Patch |

## Compared to 1.53.0 (first release of this minor)

0 added, 0 removed, 8 upgraded, 203 unchanged.

### Version bumps

| Package | 1.53.0 | 1.53.2 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-defaults` | 0.17.5 | 0.17.6 | Patch |
| `@backstage/backend-dynamic-feature-service` | 0.8.4 | 0.8.5 | Patch |
| `@backstage/cli-module-build` | 0.1.5 | 0.1.6 | Patch |
| `@backstage/cli-module-config` | 0.1.4 | 0.1.5 | Patch |
| `@backstage/config-loader` | 1.11.0 | 1.11.1 | Patch |
| `@backstage/plugin-catalog-backend` | 3.8.1 | 3.8.2 | Patch |
| `@backstage/plugin-scaffolder-backend` | 4.0.2 | 4.0.3 | Patch |
| `@backstage/plugin-scaffolder-common` | 2.2.1 | 2.2.2 | Patch |
...
1 added, 0 removed, 186 upgraded, 24 unchanged.
...
| `@backstage/plugin-catalog-backend` | 3.8.0 | 3.8.2 | Patch |
