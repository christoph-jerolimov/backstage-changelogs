# Backstage Release 1.54.1

## Compared to 1.54.0 (previous patch release)

0 added, 0 removed, 3 upgraded, 207 unchanged.

### Version bumps

| Package | 1.54.0 | 1.54.1 | Type |
| --- | --- | --- | --- |
| `@backstage/plugin-kubernetes-backend` | 0.21.7 | 0.21.8 | Patch |
...
0 added, 1 removed, 181 upgraded, 29 unchanged.
...
| `@backstage/plugin-kubernetes-backend` | 0.21.6 | 0.21.8 | Patch |
