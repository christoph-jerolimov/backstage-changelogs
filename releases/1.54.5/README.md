# Backstage Release 1.54.5

## Compared to 1.54.4 (previous patch release)

0 added, 0 removed, 3 upgraded, 207 unchanged.

### Version bumps

| Package | 1.54.4 | 1.54.5 | Type |
| --- | --- | --- | --- |
...
0 added, 0 removed, 7 upgraded, 203 unchanged.

### Version bumps

| Package | 1.54.0 | 1.54.5 | Type |
| --- | --- | --- | --- |
| `@backstage/plugin-catalog-import` | 0.13.16 | 0.13.17 | Patch |
| `@backstage/plugin-catalog-react` | 3.2.1 | 3.2.2 | Patch |
