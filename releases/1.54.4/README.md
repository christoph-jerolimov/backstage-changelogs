# Backstage Release 1.54.4

## Compared to 1.54.3 (previous patch release)

0 added, 0 removed, 1 upgraded, 209 unchanged.

### Version bumps

| Package | 1.54.3 | 1.54.4 | Type |
| --- | --- | --- | --- |
| `@backstage/plugin-scaffolder-backend` | 4.0.4 | 4.0.5 | Patch |
