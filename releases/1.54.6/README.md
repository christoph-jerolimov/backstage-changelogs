...
## Compared to 1.54.5 (previous patch release)

0 added, 0 removed, 20 upgraded, 190 unchanged.

### Version bumps

| Package | 1.54.5 | 1.54.6 | Type |
| --- | --- | --- | --- |
...
| `@backstage/plugin-kubernetes-backend` | 0.21.9 | 0.21.10 | Patch |
| `@backstage/plugin-proxy-backend` | 0.6.16 | 0.6.17 | Patch |
| `@backstage/plugin-scaffolder-backend` | 4.0.5 | 4.1.0 | Minor |
...
0 added, 0 removed, 25 upgraded, 185 unchanged.

### Version bumps

| Package | 1.54.0 | 1.54.6 | Type |
| --- | --- | --- | --- |
| `@backstage/backend-defaults` | 0.17.7 | 0.17.8 | Patch |
| `@backstage/integration` | 2.1.0 | 2.1.1 | Patch |
| `@backstage/plugin-auth-backend-module-oidc-provider` | 0.4.19 | 0.4.20 | Patch |
