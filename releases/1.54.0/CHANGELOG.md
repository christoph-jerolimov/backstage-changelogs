# Backstage Release 1.54.0 changelog

Changes between 1.53.1 and 1.54.0 — 0 added, 1 removed, 183 upgraded, 27 unchanged packages.
...
- [0.x patch version bumps](#0x-patch-version-bumps): 47 packages
...
- [Breaking changes](#breaking-changes)
  - [`@backstage/connections` (0.2.0 → 0.3.0)](#backstageconnections-020--030)
  - [`@backstage/frontend-plugin-api` (0.17.3 → 0.18.0)](#backstagefrontend-plugin-api-0173--0180)
  - [`@backstage/plugin-auth-backend` (0.29.2 → 0.30.0)](#backstageplugin-auth-backend-0292--0300)
  - [`@backstage/repo-tools` (0.18.0 → 0.19.0)](#backstagerepo-tools-0180--0190)
- [0.0.x patch version bumps](#00x-patch-version-bumps)
  - [`@backstage/release-manifests` (0.0.13 → 0.0.14)](#backstagerelease-manifests-0013--0014)
- [0.x patch version bumps](#0x-patch-version-bumps)
  - [`@backstage/backend-defaults` (0.17.6 → 0.17.7)](#backstagebackend-defaults-0176--0177)
  - [`@backstage/backend-dynamic-feature-service` (0.8.5 → 0.8.6)](#backstagebackend-dynamic-feature-service-085--086)
  - [`@backstage/cli-module-build` (0.1.6 → 0.1.7)](#backstagecli-module-build-016--017)
  - [`@backstage/cli-module-config` (0.1.5 → 0.1.6)](#backstagecli-module-config-015--016)
  - [`@backstage/cli-module-lint` (0.1.4 → 0.1.5)](#backstagecli-module-lint-014--015)
  - [`@backstage/cli-module-migrate` (0.2.0 → 0.2.1)](#backstagecli-module-migrate-020--021)
  - [`@backstage/cli-module-new` (0.1.5 → 0.1.6)](#backstagecli-module-new-015--016)
  - [`@backstage/cli-module-test-jest` (0.1.4 → 0.1.5)](#backstagecli-module-test-jest-014--015)
  - [`@backstage/core-components` (0.18.12 → 0.18.13)](#backstagecore-components-01812--01813)
  - [`@backstage/create-app` (0.9.0 → 0.9.1)](#backstagecreate-app-090--091)
  - [`@backstage/eslint-plugin` (0.3.1 → 0.3.2)](#backstageeslint-plugin-031--032)
  - [`@backstage/frontend-app-api` (0.16.6 → 0.16.7)](#backstagefrontend-app-api-0166--0167)
  - [`@backstage/frontend-dynamic-feature-loader` (0.1.14 → 0.1.15)](#backstagefrontend-dynamic-feature-loader-0114--0115)
  - [`@backstage/frontend-test-utils` (0.6.2 → 0.6.3)](#backstagefrontend-test-utils-062--063)
  - [`@backstage/integration-aws-node` (0.2.0 → 0.2.1)](#backstageintegration-aws-node-020--021)
  - [`@backstage/plugin-api-docs` (0.14.3 → 0.14.4)](#backstageplugin-api-docs-0143--0144)
  - [`@backstage/plugin-app` (0.5.1 → 0.5.2)](#backstageplugin-app-051--052)
  - [`@backstage/plugin-app-react` (0.2.5 → 0.2.6)](#backstageplugin-app-react-025--026)
  - [`@backstage/plugin-auth-backend-module-microsoft-provider` (0.3.17 → 0.3.18)](#backstageplugin-auth-backend-module-microsoft-provider-0317--0318)
  - [`@backstage/plugin-auth-node` (0.7.3 → 0.7.4)](#backstageplugin-auth-node-073--074)
  - [`@backstage/plugin-catalog-backend-module-backstage-openapi` (0.5.16 → 0.5.17)](#backstageplugin-catalog-backend-module-backstage-openapi-0516--0517)
  - [`@backstage/plugin-catalog-backend-module-incremental-ingestion` (0.7.14 → 0.7.15)](#backstageplugin-catalog-backend-module-incremental-ingestion-0714--0715)
  - [`@backstage/plugin-catalog-graph` (0.6.6 → 0.6.7)](#backstageplugin-catalog-graph-066--067)
  - [`@backstage/plugin-catalog-import` (0.13.15 → 0.13.16)](#backstageplugin-catalog-import-01315--01316)
  - [`@backstage/plugin-catalog-unprocessed-entities` (0.2.33 → 0.2.34)](#backstageplugin-catalog-unprocessed-entities-0233--0234)
  - [`@backstage/plugin-home` (0.9.8 → 0.9.9)](#backstageplugin-home-098--099)
  - [`@backstage/plugin-home-react` (0.1.40 → 0.1.41)](#backstageplugin-home-react-0140--0141)
  - [`@backstage/plugin-kubernetes-backend` (0.21.6 → 0.21.7)](#backstageplugin-kubernetes-backend-0216--0217)
  - [`@backstage/plugin-kubernetes-react` (0.5.22 → 0.5.23)](#backstageplugin-kubernetes-react-0522--0523)
  - [`@backstage/plugin-mcp-actions-backend` (0.2.0 → 0.2.1)](#backstageplugin-mcp-actions-backend-020--021)
  - [`@backstage/plugin-notifications-backend` (0.6.7 → 0.6.8)](#backstageplugin-notifications-backend-067--068)
  - [`@backstage/plugin-notifications-backend-module-email` (0.3.23 → 0.3.24)](#backstageplugin-notifications-backend-module-email-0323--0324)
  - [`@backstage/plugin-notifications-backend-module-slack` (0.4.4 → 0.4.5)](#backstageplugin-notifications-backend-module-slack-044--045)
  - [`@backstage/plugin-permission-backend` (0.7.14 → 0.7.15)](#backstageplugin-permission-backend-0714--0715)
  - [`@backstage/plugin-permission-common` (0.9.9 → 0.9.10)](#backstageplugin-permission-common-099--0910)
  - [`@backstage/plugin-permission-node` (0.11.2 → 0.11.3)](#backstageplugin-permission-node-0112--0113)
  - [`@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` (0.3.8 → 0.3.9)](#backstageplugin-scaffolder-backend-module-bitbucket-cloud-038--039)
  - [`@backstage/plugin-scaffolder-backend-module-bitbucket-server` (0.2.23 → 0.2.24)](#backstageplugin-scaffolder-backend-module-bitbucket-server-0223--0224)
  - [`@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` (0.3.23 → 0.3.24)](#backstageplugin-scaffolder-backend-module-confluence-to-markdown-0323--0324)
  - [`@backstage/plugin-scaffolder-backend-module-gerrit` (0.2.23 → 0.2.24)](#backstageplugin-scaffolder-backend-module-gerrit-0223--0224)
  - [`@backstage/plugin-scaffolder-backend-module-gitea` (0.2.23 → 0.2.24)](#backstageplugin-scaffolder-backend-module-gitea-0223--0224)
  - [`@backstage/plugin-scaffolder-node` (0.13.5 → 0.13.6)](#backstageplugin-scaffolder-node-0135--0136)
  - [`@backstage/plugin-search-backend-module-explore` (0.3.16 → 0.3.17)](#backstageplugin-search-backend-module-explore-0316--0317)
  - [`@backstage/plugin-search-backend-module-stack-overflow-collator` (0.3.22 → 0.3.23)](#backstageplugin-search-backend-module-stack-overflow-collator-0322--0323)
  - [`@backstage/plugin-search-backend-module-techdocs` (0.4.16 → 0.4.17)](#backstageplugin-search-backend-module-techdocs-0416--0417)
  - [`@backstage/plugin-user-settings` (0.9.5 → 0.9.6)](#backstageplugin-user-settings-095--096)
  - [`@backstage/ui` (0.17.0 → 0.17.1)](#backstageui-0170--0171)
- [Minor version bumps](#minor-version-bumps)
  - [`@backstage/backend-plugin-api` (1.9.3 → 1.10.0)](#backstagebackend-plugin-api-193--1100)
  ...
  - [`@backstage/plugin-catalog-backend` (3.8.1 → 3.9.0)](#backstageplugin-catalog-backend-381--390)
  - [`@backstage/plugin-techdocs` (1.17.8 → 1.18.0)](#backstageplugin-techdocs-1178--1180)
- [Other patch version bumps](#other-patch-version-bumps)
  - [`@backstage/backend-app-api` (1.7.2 → 1.7.3)](#backstagebackend-app-api-172--173)
  - [`@backstage/backend-test-utils` (1.11.5 → 1.11.6)](#backstagebackend-test-utils-1115--1116)
  - [`@backstage/config-loader` (1.11.1 → 1.11.2)](#backstageconfig-loader-1111--1112)
  - [`@backstage/core-app-api` (1.20.3 → 1.20.4)](#backstagecore-app-api-1203--1204)
  - [`@backstage/core-plugin-api` (1.12.8 → 1.12.9)](#backstagecore-plugin-api-1128--1129)
  - [`@backstage/plugin-catalog` (2.0.7 → 2.0.8)](#backstageplugin-catalog-207--208)
  - [`@backstage/plugin-catalog-react` (3.2.0 → 3.2.1)](#backstageplugin-catalog-react-320--321)
  - [`@backstage/plugin-gateway-backend` (1.1.7 → 1.1.8)](#backstageplugin-gateway-backend-117--118)
  - [`@backstage/plugin-scaffolder` (1.38.1 → 1.38.2)](#backstageplugin-scaffolder-1381--1382)
  ...
  - [`@backstage/plugin-search` (1.7.6 → 1.7.7)](#backstageplugin-search-176--177)
  - [`@backstage/plugin-techdocs-node` (1.15.2 → 1.15.3)](#backstageplugin-techdocs-node-1152--1153)
  - [`@backstage/test-utils` (1.7.20 → 1.7.21)](#backstagetest-utils-1720--1721)
- [Excluded dependency updates](#excluded-dependency-updates)

## Removed packages

- `@backstage/codemods` ([0.1.58](../../changelogs/@backstage/codemods.md#0158))

## Breaking changes

### `@backstage/connections` (0.2.0 → [0.3.0](../../changelogs/@backstage/connections.md#030))
...
### `@backstage/frontend-plugin-api` (0.17.3 → [0.18.0](../../changelogs/@backstage/frontend-plugin-api.md#0180))
...
### `@backstage/plugin-auth-backend` (0.29.2 → [0.30.0](../../changelogs/@backstage/plugin-auth-backend.md#0300))
...
### `@backstage/repo-tools` (0.18.0 → [0.19.0](../../changelogs/@backstage/repo-tools.md#0190))
...
### `@backstage/backend-defaults` (0.17.6 → [0.17.7](../../changelogs/@backstage/backend-defaults.md#0177))
...
### `@backstage/backend-dynamic-feature-service` (0.8.5 → [0.8.6](../../changelogs/@backstage/backend-dynamic-feature-service.md#086))
...
### `@backstage/cli-module-build` (0.1.6 → [0.1.7](../../changelogs/@backstage/cli-module-build.md#017))
...
### `@backstage/cli-module-config` (0.1.5 → [0.1.6](../../changelogs/@backstage/cli-module-config.md#016))
...
### `@backstage/cli-module-lint` (0.1.4 → [0.1.5](../../changelogs/@backstage/cli-module-lint.md#015))
...
### `@backstage/cli-module-migrate` (0.2.0 → [0.2.1](../../changelogs/@backstage/cli-module-migrate.md#021))
...
### `@backstage/cli-module-new` (0.1.5 → [0.1.6](../../changelogs/@backstage/cli-module-new.md#016))
...
### `@backstage/cli-module-test-jest` (0.1.4 → [0.1.5](../../changelogs/@backstage/cli-module-test-jest.md#015))
...
### `@backstage/core-components` (0.18.12 → [0.18.13](../../changelogs/@backstage/core-components.md#01813))
...
### `@backstage/create-app` (0.9.0 → [0.9.1](../../changelogs/@backstage/create-app.md#091))
...
### `@backstage/frontend-app-api` (0.16.6 → [0.16.7](../../changelogs/@backstage/frontend-app-api.md#0167))
...
### `@backstage/frontend-dynamic-feature-loader` (0.1.14 → [0.1.15](../../changelogs/@backstage/frontend-dynamic-feature-loader.md#0115))
...
### `@backstage/frontend-test-utils` (0.6.2 → [0.6.3](../../changelogs/@backstage/frontend-test-utils.md#063))
...
### `@backstage/plugin-api-docs` (0.14.3 → [0.14.4](../../changelogs/@backstage/plugin-api-docs.md#0144))
...
### `@backstage/plugin-app` (0.5.1 → [0.5.2](../../changelogs/@backstage/plugin-app.md#052))
...
### `@backstage/plugin-app-react` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-app-react.md#026))
...
### `@backstage/plugin-auth-backend-module-microsoft-provider` (0.3.17 → [0.3.18](../../changelogs/@backstage/plugin-auth-backend-module-microsoft-provider.md#0318))
...
### `@backstage/plugin-auth-node` (0.7.3 → [0.7.4](../../changelogs/@backstage/plugin-auth-node.md#074))
...
### `@backstage/plugin-catalog-backend-module-backstage-openapi` (0.5.16 → [0.5.17](../../changelogs/@backstage/plugin-catalog-backend-module-backstage-openapi.md#0517))
...
### `@backstage/plugin-catalog-backend-module-incremental-ingestion` (0.7.14 → [0.7.15](../../changelogs/@backstage/plugin-catalog-backend-module-incremental-ingestion.md#0715))
...
### `@backstage/plugin-catalog-graph` (0.6.6 → [0.6.7](../../changelogs/@backstage/plugin-catalog-graph.md#067))
...
### `@backstage/plugin-catalog-import` (0.13.15 → [0.13.16](../../changelogs/@backstage/plugin-catalog-import.md#01316))
...
### `@backstage/plugin-catalog-unprocessed-entities` (0.2.33 → [0.2.34](../../changelogs/@backstage/plugin-catalog-unprocessed-entities.md#0234))
...
### `@backstage/plugin-home` (0.9.8 → [0.9.9](../../changelogs/@backstage/plugin-home.md#099))
...
### `@backstage/plugin-home-react` (0.1.40 → [0.1.41](../../changelogs/@backstage/plugin-home-react.md#0141))
...
### `@backstage/plugin-kubernetes-backend` (0.21.6 → [0.21.7](../../changelogs/@backstage/plugin-kubernetes-backend.md#0217))
...
### `@backstage/plugin-kubernetes-react` (0.5.22 → [0.5.23](../../changelogs/@backstage/plugin-kubernetes-react.md#0523))
...
### `@backstage/plugin-mcp-actions-backend` (0.2.0 → [0.2.1](../../changelogs/@backstage/plugin-mcp-actions-backend.md#021))
...
### `@backstage/plugin-notifications-backend` (0.6.7 → [0.6.8](../../changelogs/@backstage/plugin-notifications-backend.md#068))
...
### `@backstage/plugin-notifications-backend-module-email` (0.3.23 → [0.3.24](../../changelogs/@backstage/plugin-notifications-backend-module-email.md#0324))
...
### `@backstage/plugin-notifications-backend-module-slack` (0.4.4 → [0.4.5](../../changelogs/@backstage/plugin-notifications-backend-module-slack.md#045))
...
### `@backstage/plugin-permission-backend` (0.7.14 → [0.7.15](../../changelogs/@backstage/plugin-permission-backend.md#0715))
...
### `@backstage/plugin-permission-node` (0.11.2 → [0.11.3](../../changelogs/@backstage/plugin-permission-node.md#0113))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket-cloud` (0.3.8 → [0.3.9](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-cloud.md#039))
...
### `@backstage/plugin-scaffolder-backend-module-bitbucket-server` (0.2.23 → [0.2.24](../../changelogs/@backstage/plugin-scaffolder-backend-module-bitbucket-server.md#0224))
...
### `@backstage/plugin-scaffolder-backend-module-confluence-to-markdown` (0.3.23 → [0.3.24](../../changelogs/@backstage/plugin-scaffolder-backend-module-confluence-to-markdown.md#0324))
...
### `@backstage/plugin-scaffolder-backend-module-gerrit` (0.2.23 → [0.2.24](../../changelogs/@backstage/plugin-scaffolder-backend-module-gerrit.md#0224))
...
### `@backstage/plugin-scaffolder-backend-module-gitea` (0.2.23 → [0.2.24](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitea.md#0224))
...
### `@backstage/plugin-scaffolder-node` (0.13.5 → [0.13.6](../../changelogs/@backstage/plugin-scaffolder-node.md#0136))
...
### `@backstage/plugin-search-backend-module-explore` (0.3.16 → [0.3.17](../../changelogs/@backstage/plugin-search-backend-module-explore.md#0317))
...
### `@backstage/plugin-search-backend-module-stack-overflow-collator` (0.3.22 → [0.3.23](../../changelogs/@backstage/plugin-search-backend-module-stack-overflow-collator.md#0323))
...
### `@backstage/plugin-search-backend-module-techdocs` (0.4.16 → [0.4.17](../../changelogs/@backstage/plugin-search-backend-module-techdocs.md#0417))
...
### `@backstage/plugin-user-settings` (0.9.5 → [0.9.6](../../changelogs/@backstage/plugin-user-settings.md#096))
...
### `@backstage/ui` (0.17.0 → [0.17.1](../../changelogs/@backstage/ui.md#0171))
...
### `@backstage/backend-plugin-api` (1.9.3 → [1.10.0](../../changelogs/@backstage/backend-plugin-api.md#1100))
...
### `@backstage/plugin-catalog-backend` (3.8.1 → [3.9.0](../../changelogs/@backstage/plugin-catalog-backend.md#390))
...
### `@backstage/plugin-techdocs` (1.17.8 → [1.18.0](../../changelogs/@backstage/plugin-techdocs.md#1180))
...
### `@backstage/backend-app-api` (1.7.2 → [1.7.3](../../changelogs/@backstage/backend-app-api.md#173))
...
### `@backstage/backend-test-utils` (1.11.5 → [1.11.6](../../changelogs/@backstage/backend-test-utils.md#1116))
...
### `@backstage/config-loader` (1.11.1 → [1.11.2](../../changelogs/@backstage/config-loader.md#1112))
...
### `@backstage/core-app-api` (1.20.3 → [1.20.4](../../changelogs/@backstage/core-app-api.md#1204))
...
### `@backstage/core-plugin-api` (1.12.8 → [1.12.9](../../changelogs/@backstage/core-plugin-api.md#1129))
...
### `@backstage/plugin-catalog` (2.0.7 → [2.0.8](../../changelogs/@backstage/plugin-catalog.md#208))
...
### `@backstage/plugin-catalog-react` (3.2.0 → [3.2.1](../../changelogs/@backstage/plugin-catalog-react.md#321))
...
### `@backstage/plugin-gateway-backend` (1.1.7 → [1.1.8](../../changelogs/@backstage/plugin-gateway-backend.md#118))
...
### `@backstage/plugin-scaffolder` (1.38.1 → [1.38.2](../../changelogs/@backstage/plugin-scaffolder.md#1382))
...
### `@backstage/plugin-search` (1.7.6 → [1.7.7](../../changelogs/@backstage/plugin-search.md#177))
...
### `@backstage/plugin-techdocs-node` (1.15.2 → [1.15.3](../../changelogs/@backstage/plugin-techdocs-node.md#1153))
...
### `@backstage/test-utils` (1.7.20 → [1.7.21](../../changelogs/@backstage/test-utils.md#1721))
...
- `@backstage/app-defaults` (1.7.10 → [1.7.11](../../changelogs/@backstage/app-defaults.md#1711))
- `@backstage/backend-openapi-utils` (0.7.0 → [0.7.1](../../changelogs/@backstage/backend-openapi-utils.md#071))
- `@backstage/cli` (0.36.4 → [0.36.5](../../changelogs/@backstage/cli.md#0365))
- `@backstage/cli-defaults` (0.1.4 → [0.1.5](../../changelogs/@backstage/cli-defaults.md#015))
- `@backstage/core-compat-api` (0.5.13 → [0.5.14](../../changelogs/@backstage/core-compat-api.md#0514))
- `@backstage/dev-utils` (1.1.25 → [1.1.26](../../changelogs/@backstage/dev-utils.md#1126))
- `@backstage/frontend-defaults` (0.5.4 → [0.5.5](../../changelogs/@backstage/frontend-defaults.md#055))
- `@backstage/frontend-dev-utils` (0.1.4 → [0.1.5](../../changelogs/@backstage/frontend-dev-utils.md#015))
- `@backstage/integration-react` (1.2.20 → [1.2.21](../../changelogs/@backstage/integration-react.md#1221))
- `@backstage/plugin-app-backend` (0.5.16 → [0.5.17](../../changelogs/@backstage/plugin-app-backend.md#0517))
- `@backstage/plugin-app-module-user-settings` (0.1.0 → [0.1.1](../../changelogs/@backstage/plugin-app-module-user-settings.md#011))
- `@backstage/plugin-app-node` (0.1.47 → [0.1.48](../../changelogs/@backstage/plugin-app-node.md#0148))
- `@backstage/plugin-app-visualizer` (0.2.6 → [0.2.7](../../changelogs/@backstage/plugin-app-visualizer.md#027))
- `@backstage/plugin-auth` (0.1.10 → [0.1.11](../../changelogs/@backstage/plugin-auth.md#0111))
- `@backstage/plugin-auth-backend-module-atlassian-provider` (0.4.17 → [0.4.18](../../changelogs/@backstage/plugin-auth-backend-module-atlassian-provider.md#0418))
- `@backstage/plugin-auth-backend-module-auth0-provider` (0.4.3 → [0.4.4](../../changelogs/@backstage/plugin-auth-backend-module-auth0-provider.md#044))
- `@backstage/plugin-auth-backend-module-aws-alb-provider` (0.4.18 → [0.4.19](../../changelogs/@backstage/plugin-auth-backend-module-aws-alb-provider.md#0419))
- `@backstage/plugin-auth-backend-module-azure-easyauth-provider` (0.2.22 → [0.2.23](../../changelogs/@backstage/plugin-auth-backend-module-azure-easyauth-provider.md#0223))
- `@backstage/plugin-auth-backend-module-bitbucket-provider` (0.3.17 → [0.3.18](../../changelogs/@backstage/plugin-auth-backend-module-bitbucket-provider.md#0318))
- `@backstage/plugin-auth-backend-module-bitbucket-server-provider` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-auth-backend-module-bitbucket-server-provider.md#0218))
- `@backstage/plugin-auth-backend-module-cloudflare-access-provider` (0.4.17 → [0.4.18](../../changelogs/@backstage/plugin-auth-backend-module-cloudflare-access-provider.md#0418))
- `@backstage/plugin-auth-backend-module-gcp-iap-provider` (0.4.17 → [0.4.18](../../changelogs/@backstage/plugin-auth-backend-module-gcp-iap-provider.md#0418))
- `@backstage/plugin-auth-backend-module-github-provider` (0.5.5 → [0.5.6](../../changelogs/@backstage/plugin-auth-backend-module-github-provider.md#056))
- `@backstage/plugin-auth-backend-module-gitlab-provider` (0.4.5 → [0.4.6](../../changelogs/@backstage/plugin-auth-backend-module-gitlab-provider.md#046))
- `@backstage/plugin-auth-backend-module-google-provider` (0.3.17 → [0.3.18](../../changelogs/@backstage/plugin-auth-backend-module-google-provider.md#0318))
- `@backstage/plugin-auth-backend-module-guest-provider` (0.2.21 → [0.2.22](../../changelogs/@backstage/plugin-auth-backend-module-guest-provider.md#0222))
- `@backstage/plugin-auth-backend-module-oauth2-provider` (0.4.17 → [0.4.18](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-provider.md#0418))
- `@backstage/plugin-auth-backend-module-oauth2-proxy-provider` (0.3.1 → [0.3.2](../../changelogs/@backstage/plugin-auth-backend-module-oauth2-proxy-provider.md#032))
- `@backstage/plugin-auth-backend-module-oidc-provider` (0.4.18 → [0.4.19](../../changelogs/@backstage/plugin-auth-backend-module-oidc-provider.md#0419))
- `@backstage/plugin-auth-backend-module-okta-provider` (0.2.17 → [0.2.18](../../changelogs/@backstage/plugin-auth-backend-module-okta-provider.md#0218))
- `@backstage/plugin-auth-backend-module-onelogin-provider` (0.3.17 → [0.3.18](../../changelogs/@backstage/plugin-auth-backend-module-onelogin-provider.md#0318))
- `@backstage/plugin-auth-backend-module-openshift-provider` (0.1.9 → [0.1.10](../../changelogs/@backstage/plugin-auth-backend-module-openshift-provider.md#0110))
- `@backstage/plugin-auth-backend-module-pinniped-provider` (0.3.16 → [0.3.17](../../changelogs/@backstage/plugin-auth-backend-module-pinniped-provider.md#0317))
- `@backstage/plugin-auth-backend-module-vmware-cloud-provider` (0.5.16 → [0.5.17](../../changelogs/@backstage/plugin-auth-backend-module-vmware-cloud-provider.md#0517))
- `@backstage/plugin-auth-react` (0.1.29 → [0.1.30](../../changelogs/@backstage/plugin-auth-react.md#0130))
- `@backstage/plugin-bitbucket-cloud-common` (0.3.11 → [0.3.12](../../changelogs/@backstage/plugin-bitbucket-cloud-common.md#0312))
- `@backstage/plugin-catalog-backend-module-ai-model` (0.1.2 → [0.1.3](../../changelogs/@backstage/plugin-catalog-backend-module-ai-model.md#013))
- `@backstage/plugin-catalog-backend-module-aws` (0.4.25 → [0.4.26](../../changelogs/@backstage/plugin-catalog-backend-module-aws.md#0426))
- `@backstage/plugin-catalog-backend-module-azure` (0.3.19 → [0.3.20](../../changelogs/@backstage/plugin-catalog-backend-module-azure.md#0320))
- `@backstage/plugin-catalog-backend-module-bitbucket-cloud` (0.5.13 → [0.5.14](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-cloud.md#0514))
- `@backstage/plugin-catalog-backend-module-bitbucket-server` (0.5.13 → [0.5.14](../../changelogs/@backstage/plugin-catalog-backend-module-bitbucket-server.md#0514))
- `@backstage/plugin-catalog-backend-module-gcp` (0.3.21 → [0.3.22](../../changelogs/@backstage/plugin-catalog-backend-module-gcp.md#0322))
- `@backstage/plugin-catalog-backend-module-gerrit` (0.3.16 → [0.3.17](../../changelogs/@backstage/plugin-catalog-backend-module-gerrit.md#0317))
- `@backstage/plugin-catalog-backend-module-gitea` (0.1.14 → [0.1.15](../../changelogs/@backstage/plugin-catalog-backend-module-gitea.md#0115))
- `@backstage/plugin-catalog-backend-module-github` (0.13.4 → [0.13.5](../../changelogs/@backstage/plugin-catalog-backend-module-github.md#0135))
- `@backstage/plugin-catalog-backend-module-github-org` (0.3.24 → [0.3.25](../../changelogs/@backstage/plugin-catalog-backend-module-github-org.md#0325))
- `@backstage/plugin-catalog-backend-module-gitlab` (0.8.5 → [0.8.6](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab.md#086))
- `@backstage/plugin-catalog-backend-module-gitlab-org` (0.2.23 → [0.2.24](../../changelogs/@backstage/plugin-catalog-backend-module-gitlab-org.md#0224))
- `@backstage/plugin-catalog-backend-module-ldap` (0.12.7 → [0.12.8](../../changelogs/@backstage/plugin-catalog-backend-module-ldap.md#0128))
- `@backstage/plugin-catalog-backend-module-logs` (0.1.24 → [0.1.25](../../changelogs/@backstage/plugin-catalog-backend-module-logs.md#0125))
- `@backstage/plugin-catalog-backend-module-msgraph` (0.10.4 → [0.10.5](../../changelogs/@backstage/plugin-catalog-backend-module-msgraph.md#0105))
- `@backstage/plugin-catalog-backend-module-msgraph-incremental` (0.1.2 → [0.1.3](../../changelogs/@backstage/plugin-catalog-backend-module-msgraph-incremental.md#013))
- `@backstage/plugin-catalog-backend-module-openapi` (0.2.24 → [0.2.25](../../changelogs/@backstage/plugin-catalog-backend-module-openapi.md#0225))
- `@backstage/plugin-catalog-backend-module-puppetdb` (0.2.24 → [0.2.25](../../changelogs/@backstage/plugin-catalog-backend-module-puppetdb.md#0225))
- `@backstage/plugin-catalog-backend-module-scaffolder-entity-model` (0.2.22 → [0.2.23](../../changelogs/@backstage/plugin-catalog-backend-module-scaffolder-entity-model.md#0223))
- `@backstage/plugin-catalog-backend-module-unprocessed` (0.6.14 → [0.6.15](../../changelogs/@backstage/plugin-catalog-backend-module-unprocessed.md#0615))
- `@backstage/plugin-catalog-node` (2.2.3 → [2.2.4](../../changelogs/@backstage/plugin-catalog-node.md#224))
- `@backstage/plugin-config-schema` (0.1.82 → [0.1.83](../../changelogs/@backstage/plugin-config-schema.md#0183))
- `@backstage/plugin-devtools` (0.1.41 → [0.1.42](../../changelogs/@backstage/plugin-devtools.md#0142))
- `@backstage/plugin-devtools-backend` (0.5.19 → [0.5.20](../../changelogs/@backstage/plugin-devtools-backend.md#0520))
- `@backstage/plugin-devtools-react` (0.2.4 → [0.2.5](../../changelogs/@backstage/plugin-devtools-react.md#025))
- `@backstage/plugin-events-backend` (0.6.4 → [0.6.5](../../changelogs/@backstage/plugin-events-backend.md#065))
- `@backstage/plugin-events-backend-module-aws-sqs` (0.4.24 → [0.4.25](../../changelogs/@backstage/plugin-events-backend-module-aws-sqs.md#0425))
- `@backstage/plugin-events-backend-module-azure` (0.2.33 → [0.2.34](../../changelogs/@backstage/plugin-events-backend-module-azure.md#0234))
- `@backstage/plugin-events-backend-module-bitbucket-cloud` (0.2.33 → [0.2.34](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-cloud.md#0234))
- `@backstage/plugin-events-backend-module-bitbucket-server` (0.1.14 → [0.1.15](../../changelogs/@backstage/plugin-events-backend-module-bitbucket-server.md#0115))
- `@backstage/plugin-events-backend-module-gerrit` (0.2.33 → [0.2.34](../../changelogs/@backstage/plugin-events-backend-module-gerrit.md#0234))
- `@backstage/plugin-events-backend-module-github` (0.4.14 → [0.4.15](../../changelogs/@backstage/plugin-events-backend-module-github.md#0415))
- `@backstage/plugin-events-backend-module-gitlab` (0.3.14 → [0.3.15](../../changelogs/@backstage/plugin-events-backend-module-gitlab.md#0315))
- `@backstage/plugin-events-backend-module-google-pubsub` (0.2.5 → [0.2.6](../../changelogs/@backstage/plugin-events-backend-module-google-pubsub.md#026))
- `@backstage/plugin-events-backend-module-kafka` (0.3.6 → [0.3.7](../../changelogs/@backstage/plugin-events-backend-module-kafka.md#037))
- `@backstage/plugin-events-backend-test-utils` (0.1.57 → [0.1.58](../../changelogs/@backstage/plugin-events-backend-test-utils.md#0158))
- `@backstage/plugin-events-node` (0.4.24 → [0.4.25](../../changelogs/@backstage/plugin-events-node.md#0425))
- `@backstage/plugin-kubernetes` (0.12.21 → [0.12.22](../../changelogs/@backstage/plugin-kubernetes.md#01222))
- `@backstage/plugin-kubernetes-cluster` (0.0.39 → [0.0.40](../../changelogs/@backstage/plugin-kubernetes-cluster.md#0040))
- `@backstage/plugin-kubernetes-node` (0.4.6 → [0.4.7](../../changelogs/@backstage/plugin-kubernetes-node.md#047))
- `@backstage/plugin-mui-to-bui` (0.2.9 → [0.2.10](../../changelogs/@backstage/plugin-mui-to-bui.md#0210))
- `@backstage/plugin-notifications` (0.5.19 → [0.5.20](../../changelogs/@backstage/plugin-notifications.md#0520))
- `@backstage/plugin-notifications-node` (0.2.28 → [0.2.29](../../changelogs/@backstage/plugin-notifications-node.md#0229))
- `@backstage/plugin-org` (0.7.6 → [0.7.7](../../changelogs/@backstage/plugin-org.md#077))
- `@backstage/plugin-org-react` (0.1.52 → [0.1.53](../../changelogs/@backstage/plugin-org-react.md#0153))
- `@backstage/plugin-permission-backend-module-allow-all-policy` (0.2.21 → [0.2.22](../../changelogs/@backstage/plugin-permission-backend-module-allow-all-policy.md#0222))
- `@backstage/plugin-permission-react` (0.5.3 → [0.5.4](../../changelogs/@backstage/plugin-permission-react.md#054))
- `@backstage/plugin-proxy-backend` (0.6.15 → [0.6.16](../../changelogs/@backstage/plugin-proxy-backend.md#0616))
- `@backstage/plugin-proxy-node` (0.1.17 → [0.1.18](../../changelogs/@backstage/plugin-proxy-node.md#0118))
- `@backstage/plugin-scaffolder-backend-module-azure` (0.2.23 → [0.2.24](../../changelogs/@backstage/plugin-scaffolder-backend-module-azure.md#0224))
- `@backstage/plugin-scaffolder-backend-module-cookiecutter` (0.3.25 → [0.3.26](../../changelogs/@backstage/plugin-scaffolder-backend-module-cookiecutter.md#0326))
- `@backstage/plugin-scaffolder-backend-module-gcp` (0.2.23 → [0.2.24](../../changelogs/@backstage/plugin-scaffolder-backend-module-gcp.md#0224))
- `@backstage/plugin-scaffolder-backend-module-github` (0.9.11 → [0.9.12](../../changelogs/@backstage/plugin-scaffolder-backend-module-github.md#0912))
- `@backstage/plugin-scaffolder-backend-module-gitlab` (0.11.8 → [0.11.9](../../changelogs/@backstage/plugin-scaffolder-backend-module-gitlab.md#0119))
- `@backstage/plugin-scaffolder-backend-module-notifications` (0.1.24 → [0.1.25](../../changelogs/@backstage/plugin-scaffolder-backend-module-notifications.md#0125))
- `@backstage/plugin-scaffolder-backend-module-rails` (0.5.23 → [0.5.24](../../changelogs/@backstage/plugin-scaffolder-backend-module-rails.md#0524))
- `@backstage/plugin-scaffolder-backend-module-sentry` (0.3.6 → [0.3.7](../../changelogs/@backstage/plugin-scaffolder-backend-module-sentry.md#037))
- `@backstage/plugin-scaffolder-backend-module-yeoman` (0.4.24 → [0.4.25](../../changelogs/@backstage/plugin-scaffolder-backend-module-yeoman.md#0425))
- `@backstage/plugin-scaffolder-node-test-utils` (0.3.13 → [0.3.14](../../changelogs/@backstage/plugin-scaffolder-node-test-utils.md#0314))
- `@backstage/plugin-scaffolder-react` (2.0.2 → [2.0.3](../../changelogs/@backstage/plugin-scaffolder-react.md#203))
- `@backstage/plugin-search-backend` (2.1.4 → [2.1.5](../../changelogs/@backstage/plugin-search-backend.md#215))
- `@backstage/plugin-search-backend-module-catalog` (0.3.17 → [0.3.18](../../changelogs/@backstage/plugin-search-backend-module-catalog.md#0318))
- `@backstage/plugin-search-backend-module-elasticsearch` (1.8.5 → [1.8.6](../../changelogs/@backstage/plugin-search-backend-module-elasticsearch.md#186))
- `@backstage/plugin-search-backend-module-pg` (0.5.57 → [0.5.58](../../changelogs/@backstage/plugin-search-backend-module-pg.md#0558))
- `@backstage/plugin-search-backend-node` (1.4.6 → [1.4.7](../../changelogs/@backstage/plugin-search-backend-node.md#147))
- `@backstage/plugin-search-react` (1.11.6 → [1.11.7](../../changelogs/@backstage/plugin-search-react.md#1117))
- `@backstage/plugin-signals` (0.0.33 → [0.0.34](../../changelogs/@backstage/plugin-signals.md#0034))
- `@backstage/plugin-signals-backend` (0.3.17 → [0.3.18](../../changelogs/@backstage/plugin-signals-backend.md#0318))
- `@backstage/plugin-signals-node` (0.2.3 → [0.2.4](../../changelogs/@backstage/plugin-signals-node.md#024))
- `@backstage/plugin-signals-react` (0.0.24 → [0.0.25](../../changelogs/@backstage/plugin-signals-react.md#0025))
- `@backstage/plugin-techdocs-addons-test-utils` (2.0.7 → [2.0.8](../../changelogs/@backstage/plugin-techdocs-addons-test-utils.md#208))
- `@backstage/plugin-techdocs-backend` (2.2.2 → [2.2.3](../../changelogs/@backstage/plugin-techdocs-backend.md#223))
- `@backstage/plugin-techdocs-module-addons-contrib` (1.1.38 → [1.1.39](../../changelogs/@backstage/plugin-techdocs-module-addons-contrib.md#1139))
- `@backstage/plugin-techdocs-react` (1.3.13 → [1.3.14](../../changelogs/@backstage/plugin-techdocs-react.md#1314))
- `@backstage/plugin-user-settings-backend` (0.4.5 → [0.4.6](../../changelogs/@backstage/plugin-user-settings-backend.md#046))
- `@techdocs/cli` (1.11.2 → [1.11.3](../../changelogs/@techdocs/cli.md#1113))
