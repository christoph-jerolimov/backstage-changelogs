...
Changes between 1.53.2 and 1.54.0 — 0 added, 1 removed, 181 upgraded, 29 unchanged packages.
...
- [Minor version bumps](#minor-version-bumps)
  ...
  - [`@backstage/plugin-catalog-backend` (3.8.2 → 3.9.0)](#backstageplugin-catalog-backend-382--390)
...
### `@backstage/plugin-catalog-backend` (3.8.2 → [3.9.0](../../changelogs/@backstage/plugin-catalog-backend.md#390))
