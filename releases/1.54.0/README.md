...
| `@backstage/plugin-kubernetes-backend` | 0.21.6 | 0.21.7 | Patch |
...
| `@backstage/plugin-search-backend` | 2.1.4 | 2.1.5 | Patch |
| `@backstage/plugin-search-backend-module-catalog` | 0.3.17 | 0.3.18 | Patch |
| `@backstage/plugin-search-backend-module-elasticsearch` | 1.8.5 | 1.8.6 | Patch |
