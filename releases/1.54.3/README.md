# Backstage Release 1.54.3

## Compared to 1.54.2 (previous patch release)

0 added, 0 removed, 1 upgraded, 209 unchanged.

### Version bumps

| Package | 1.54.2 | 1.54.3 | Type |
| --- | --- | --- | --- |
| `@backstage/plugin-scaffolder-backend` | 4.0.3 | 4.0.4 | Patch |

## Compared to 1.54.0 (first release of this minor)

0 added, 0 removed, 4 upgraded, 206 unchanged.

### Version bumps

| Package | 1.54.0 | 1.54.3 | Type |
| --- | --- | --- | --- |
...
| `@backstage/plugin-scaffolder-backend` | 4.0.2 | 4.0.4 | Patch |
